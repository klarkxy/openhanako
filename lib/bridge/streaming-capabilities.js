...
const STREAMING_MODES = new Set(["draft", "edit_message", "block", "batch", "batch_pulse"]);

/**
 * @param {object} opts
 * @param {string} opts.platform
 * @param {"draft"|"edit_message"|"block"|"batch"|"batch_pulse"} opts.mode
 ...
 * @param {number} [opts.pulseIntervalMs]  batch_pulse 专用：脉冲间隔（毫秒）
