...
export const REUSABLE_SUBAGENT_STORE_VERSION = 1;
...
export class ReusableSubagentStore {
  ...
  _load() {
    ...
    // 读时兼容：优先 { schemaVersion, instances }，退回裸 map（老/脏数据）。
    const instances = raw?.instances && typeof raw.instances === "object" ? raw.instances : raw;
