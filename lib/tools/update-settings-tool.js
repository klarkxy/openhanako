/**
 * update-settings-tool.js — Settings update tool (progressive disclosure)
 *
 * Two-phase call: search to find settings → apply to modify settings.
...
const SETTINGS_REGISTRY = {
  ...
  thinking_lang: {
    type: "list",
    get label() { return "思考语言 / Thinking Language"; },
    description: "Set the default language for agent thinking and replies. auto = follow UI language",
    options: ["auto", "zh", "en"],
    optionLabels: { auto: "自动 / Auto", zh: "中文", en: "English" },
    searchTerms: ["language", "思考", "thinking", "语言", "中文", "英文", "言語"],
    get: (engine, _agent) => engine.getThinkingLang(),
    apply: (engine, _agent, v) => engine.setThinkingLang(v),
  },
  timezone: {
    type: "text",
